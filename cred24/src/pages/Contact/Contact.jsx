			...
			<div className="contactus ">
				<Parallax
					...
					<ParallaxLayer offset={0} speed={-0.4}>
						<div className="flex items-start justify-center font-extrabold text-center text-blue-200 align-middle animation_layer parallax text-9xl">
						...
						<div className="flex-col m-10 ">
							...
							<div className="flex justify-around gap-5 m-10 cardb">
								<ContactProfileCard
									...
									name={'Prasanna Pande'}
									image={imgpp}
									pos={'Vice Chairperson'}></ContactProfileCard>
								<ContactProfileCard
									className=""
									name={'Harsh Khandelwal'}
									image={imghs}
									pos={'Joint Secretary'}></ContactProfileCard>
								<ContactProfileCard
									className=""
									name={'Shruti Shinde'}
									image={imgsh}
							...
							<div className="flex justify-around gap-5 m-10  cardb">
								<ContactProfileCard
									className=""
									name={'Karan Mundhada'}
									image={imgkrn}></ContactProfileCard>
								<ContactProfileCard
									className=""
									name={'Jeeya Shah'}
									src={``}></ContactProfileCard>
								<ContactProfileCard
									className=""
									name={'Kaushal Lande'}
									src={``}></ContactProfileCard>
					...
					<ParallaxLayer offset={2} style={{ marginTop: 200 }} speed={1}>
						<div className="flex flex-col md:flex-row">
							...
							<iframe
								className="w-full p-5  map rounded-3xl md:w-1/2 md:mx-10 md:mb-20"
